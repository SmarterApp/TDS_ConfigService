...
public class AccommodationsQueryRepositoryImplIntegrationTests {
    ...
    public void setUp() {
        ...
        String segmentPropertiesInsertSQL = "INSERT INTO client_segmentproperties (ispermeable, clientname, entryapproval, exitapproval, segmentid, segmentposition, parenttest) VALUES (1, 'SBAC_PT', 1, 1, 'SBAC-SEG1-MATH-11', 99, 'SBAC-Mathematics-11');";
